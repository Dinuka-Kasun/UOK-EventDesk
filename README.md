...
<span style="font-weight: bold; color: black;">Dashboard login</span>: <span style="font-weight: bold; color: black;">user</span> -> admin | <span style="font-weight: bold; color: black;">pass</span> -> test123<br><br>
